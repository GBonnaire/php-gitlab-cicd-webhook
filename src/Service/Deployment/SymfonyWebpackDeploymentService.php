...
class SymfonyWebpackDeploymentService extends BaseDeploymentService
{
    protected function getUpSteps(): array
    {
        return [
            ...
            'npm_install' => function() {
                ...
                if ($result['success']) {
                    $this->addRollbackStep('npm_install', fn() => ['success' => true, 'message' => 'NPM rollback not needed']);
                }
                return $result;
            },
            'npm_build' => function() {
                ...
                if ($result['success']) {
                    $this->addRollbackStep('npm_build', fn() => ['success' => true, 'message' => 'NPM build rollback not needed']);
                }
                return $result;
            },
